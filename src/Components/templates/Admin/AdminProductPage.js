  ...
  return (
    <>
      <Container maxWidth="lg">
        ...
        <React.Fragment>
      <Button variant="outlined" onClick={handleClickOpen} style={{margin:"auto", display:"flex", background:"linear-gradient(45deg, #00000078, white)"}}>
        Add Product
      </Button>
      <Dialog
        open={open}
      ...
      >
        ...
        <DialogContent style={{background:"linear-gradient(45deg, black, #333272)", padding:"40px"}}>
